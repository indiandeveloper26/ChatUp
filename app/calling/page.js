...
export default function IncomingCall() {
    ...
    useEffect(() => {
        if (incomingCall) {
            console.log("📞 Incoming Call Data Received:", incomingUser.callType);
        }
    }, [incomingCall]);
        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2">{incomingUser?.from || ''}</h2>
                    <p className="text-emerald-400 font-medium mb-8 animate-pulse">
                        {incomingUser?.callType === "video" ? "Incoming Video Call..." : "Incoming Audio Call..."}
                    </p>
