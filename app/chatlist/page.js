...
// MoreVertical icon import kiya hai 3 dots ke liye
import { MessageSquarePlus, Trash2, ShieldCheck, MoreVertical } from "lucide-react";
...
export default function ChatList() {
  ...
  const toggleMenu = (user, e) => {
    e.stopPropagation(); // Chat open na ho jaye
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-3 relative">
                        ...
                        <button
                          ...
                          className="p-2 text-slate-500 hover:text-white transition-all rounded-xl hover:bg-white/10"
                        >
                        ...
                        {/* DROPDOWN MENU */}
                        {activeMenu === user && (
                          <div className="absolute right-0 bottom-full mb-2 w-32 bg-[#1F2C33] border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
                            <button
                              onClick={(e) => confirmDelete(user, e)}
                              className="w-full flex items-center gap-2 px-4 py-3 text-sm text-red-400 hover:bg-white/5 transition-colors font-bold"
                            >
